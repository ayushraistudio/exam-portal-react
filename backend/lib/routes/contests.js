...
router.get('/', auth_1.verifyToken, auth_1.updateActivity, async (req, res) => {
    try {
        ...
        const snapshot = await query
            ...
            .get();
        const contests = snapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
        res.json({
            success: true,
            data: contests
        });
 ...
 */
router.get('/:id', auth_1.verifyToken, auth_1.updateActivity, async (req, res) => {
    try {
        const { id } = req.params;
 ...
 */
router.get('/:id/questions', auth_1.verifyToken, auth_1.updateActivity, async (req, res) => {
    try {
        const { id } = req.params;
 ...
 */
router.post('/:id/start', auth_1.verifyToken, auth_1.requireAdmin, auth_1.updateActivity, async (req, res) => {
    try {
        const { id } = req.params;
 ...
 */
router.post('/:id/stop', auth_1.verifyToken, auth_1.requireAdmin, auth_1.updateActivity, async (req, res) => {
    try {
        const { id } = req.params;
 ...
 */
router.post('/:id/answers', auth_1.verifyToken, auth_1.requireStudent, auth_1.updateActivity, async (req, res) => {
    try {
        const { id } = req.params;
 ...
 */
router.post('/:id/submit', auth_1.verifyToken, auth_1.requireStudent, auth_1.updateActivity, async (req, res) => {
    try {
        const { id } = req.params;
 ...
 * Get contest results
 */
router.get('/:id/results', auth_1.verifyToken, auth_1.updateActivity, async (req, res) => {
    try {
        const { id } = req.params;
 ...
 */
router.post('/', auth_1.verifyToken, auth_1.requireAdmin, auth_1.updateActivity, async (req, res) => {
    try {
 ...
 */
router.get('/:id/questions', auth_1.verifyToken, auth_1.requireStudent, auth_1.updateActivity, async (req, res) => {
    try {
        const { id } = req.params;
        const contest = await contestService.getContest(id);
        if (!contest) {
 ...
 */
router.get('/:id/results', auth_1.verifyToken, auth_1.requireAdmin, auth_1.updateActivity, async (req, res) => {
    try {
        const { id } = req.params;
        const results = await contestService.getContestResults(id);
